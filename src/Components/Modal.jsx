...
export default function Modal({ isOpen, setIsOpen, header, content, footer, setErrors }) {
  return createPortal(
    <div
    ...
    >
      <div
        className="shadow-md bg-(--bg-modal) rounded-lg hover:shadow-lg flex flex-col gap-4 sm:min-w-[650px] pb-2 px-20"
